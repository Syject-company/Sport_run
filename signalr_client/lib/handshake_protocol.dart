...
class HandshakeRequestMessage {
  ...
  Map<String,dynamic> toJson() =>  <String,dynamic>{'protocol': protocol, 'version': version};
}
...
class HandshakeProtocol {
  ...
  ParseHandshakeResponseResult parseHandshakeResponse(Object data) {
    ...
    final response =
        HandshakeResponseMessage.fromJson(json.decode(messages[0]) as Map<String,dynamic>);
