...
class JsonHubProtocol implements IHubProtocol {
  ...
  List<HubMessageBase> parseMessages(Object input, Logger logger) {
    ...
    // Parse the messages
    final List<String> messages = TextMessageFormat.parse(jsonInput);
    for (final String message in messages) {
      final Map<String, dynamic> jsonData = json.decode(message) as Map<String,dynamic>;
      final MessageType messageType = _getMessageTypeFromJson(jsonData);
  ...
  static MessageType _getMessageTypeFromJson(Map<String, dynamic> json) {
    return parseMessageTypeFromString(json['type'] as int);
  }
  ...
  static InvocationMessage _getInvocationMessageFormJson(
    ...
    final MessageHeaders headers =
        createMessageHeadersFromJson(jsonData["headers"] as Map<String,dynamic>);
    final message = InvocationMessage(jsonData['target'] as String, jsonData["arguments"] as List<Object>,
        headers, jsonData["invocationId"] as String);
  ...
  static StreamItemMessage _getStreamItemMessageFormJson(
    ...
    final MessageHeaders headers =
        createMessageHeadersFromJson(jsonData["headers"] as Map<String,dynamic>);
    final message =
        StreamItemMessage(jsonData["item"], headers, jsonData["invocationId"] as String);
  ...
  static CompletionMessage _getCompletionMessageFormJson(
    ...
    final MessageHeaders headers =
        createMessageHeadersFromJson(jsonData["headers"] as Map<String,dynamic>);
    final message = CompletionMessage(jsonData["error"] as String, jsonData['result'],
        headers, jsonData["invocationId"] as String);
  ...
  static CloseMessage _getCloseMessageFormJson(Map<String, dynamic> jsonData) {
    return CloseMessage(jsonData["error"] as String);
  }
  ...
  String writeMessage(HubMessageBase message) {
    assert(message != null);
    var  jsonObj = _messageAsMap(message) as Map<String, Object>;
